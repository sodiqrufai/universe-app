...
class _AnonymousPostDetailScreenState extends State<AnonymousPostDetailScreen> {
  ...
  Future<void> _fetchComments() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          '${ApiConfig.baseUrl}/anonymous/posts/${widget.post['id']}/comments',
        ),
  ...
  Future<void> _report() async {
    ...
    if (reason != null && reason.isNotEmpty) {
      ...
      await http.post(
        Uri.parse(
          '${ApiConfig.baseUrl}/anonymous/posts/${widget.post['id']}/report',
        ),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
            ...
            child: ListView(
              ...
              children: [
                ...
                if (_loading)
                  ...
                  ..._comments.map((c) {
                    final cUsername =
                        c['anonymous_profiles']?['anonymous_username'] ??
                        'anonymous';
                    return Padding(
